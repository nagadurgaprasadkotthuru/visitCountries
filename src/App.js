...
import CountryOptionCard from './components/CountryOptionCard'
import VisitedCountryCard from './components/VisitedCountryCard'
...
class App extends Component {
  ...
  renderCountryOptionCards = () => {
    const {countriesList} = this.state
    return (
      <ul className="country-option-cards-container">
        {countriesList.map(eachItem => (
          <CountryOptionCard
            countryOptionCardDetails={eachItem}
        ...
        {filteredList.length !== 0 ? (
          <ul className="visited-countries-container">
            {filteredList.map(eachItem => (
              <VisitedCountryCard
                visitedCountryCardDetails={eachItem}
